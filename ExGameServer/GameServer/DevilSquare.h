...
struct PMSG_DEVIL_CASTLE_STATE_SEND
{
	PBMSG_HEAD header;
	WORD RemainTime;
	int KillCur;
...
public:
	...
	void GCDevilCastleStateSend(DEVIL_SQUARE_LEVEL* lpLevel);
	void GCDevilCastleSimpleStateSend(DEVIL_SQUARE_LEVEL* lpLevel, int aIndex);
	int KillCur;
	int KillMax;
	private:
