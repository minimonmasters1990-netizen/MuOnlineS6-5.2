...
void CKanturuBattleOfMaya::SetState_ENDCYCLE_MAYA1()
{
	...
	gKanturuUtil.SendMsgKanturuBossMapUser(gMessageNew.GetMessage(275));
}
...
void CKanturuBattleOfMaya::SetState_END()
{
	...
	{
		gKanturuUtil.SendMsgKanturuBossMapUser(gMessageNew.GetMessage(283));
	}
	else
	{
		gKanturuUtil.SendMsgKanturuBossMapUser(gMessageNew.GetMessage(281));
	}
