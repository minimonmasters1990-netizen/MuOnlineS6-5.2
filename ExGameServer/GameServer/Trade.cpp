...
void CTrade::CGTradeRequestRecv(PMSG_TRADE_REQUEST_RECV* lpMsg,int aIndex)
{
	...
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0, gMessageNew.GetMessage(662));
		return;
	}
...
void CTrade::TradeDuel(LPOBJ lpObj, LPOBJ lpTarget)
{
...
void CTrade::ResetDuelTrade(int aIndex)
{
	LPOBJ lpObj = &gObj[aIndex];
