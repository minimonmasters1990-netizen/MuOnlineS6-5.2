...
BOOL ObjBotBuffer::TradeOpen(int index, int nindex)
{
	...
	for (int x = 0; x < this->bot[number].SkillCount; x++)
	{
		...
		case SKILL_MANA_SHIELD:
		{
			...
			gEffectManager.DelEffect(lpObj, EFFECT_MANA_SHIELD);
		...
		case SKILL_GREATER_DEFENSE:
		{
			...
			gEffectManager.DelEffect(lpObj, EFFECT_GREATER_DEFENSE);
		...
		case SKILL_GREATER_DAMAGE:
		{
			...
			gEffectManager.DelEffect(lpObj, EFFECT_GREATER_DAMAGE);
		...
		case SKILL_GREATER_CRITICAL_DAMAGE:
		{
			...
			gEffectManager.DelEffect(lpObj, EFFECT_GREATER_CRITICAL_DAMAGE);
		...
		case EFFECT_GREATER_IGNORE_DEFENSE_RATE:
		{
			...
			gEffectManager.DelEffect(lpObj, EFFECT_GREATER_IGNORE_DEFENSE_RATE);
		...
		{
			GCActionSend(lpBot, ACTION_RAGEBUFF_1, lpBot->Index, nindex);
			gEffectManager.DelEffect(lpObj, EFFECT_FITNESS);
