...
enum eItemOption
{
	...
	ITEM_OPTION_DMG = 128,
	ITEM_OPTION_ADD_TRIPLE_DAMAGE_RATE = 129,
	ITEM_OPTION_ADD_RESISTE_DOUBLE_RATE = 130,
	ITEM_OPTION_ADD_RESISTE_IGNOREDEFENSE_RATE = 131,
	ITEM_OPTION_ADD_RESISTE_IGNORESD_RATE = 132,
	ITEM_OPTION_ADD_RESISTE_CRITICA_DAMEGE_RATE = 133,
	ITEM_OPTION_ADD_RESISTE_EXCELLENT_DAMEGE_RATE = 134,
	ITEM_OPTION_ADD_RESISTE_STUN_RATE = 135,
};
