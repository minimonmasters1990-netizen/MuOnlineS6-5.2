...
void CRaklion::SetState_NOTIFY2()
{
	...
	gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(284), (((this->m_BossZoneCloseDelay / 60) == 0) ? 1 : (this->m_BossZoneCloseDelay / 60)));
...
void CRaklion::SetState_NOTIFY3()
{
	...
	gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(285));
...
void CRaklion::SetState_NOTIFY4()
{
	...
	gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(287), (((this->m_BossZoneOpenDelay / 60) == 0) ? 1 : (this->m_BossZoneOpenDelay / 60)));
...
void CRaklion::SetState_END()
{
	...
	gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(289));
...
void CRaklion::RaklionMonsterDieProc(LPOBJ lpObj, LPOBJ lpTarget)
{
	...
	if (lpObj->Class == 459)
	{
		...
		gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(286), lpTarget->Name);
	}
