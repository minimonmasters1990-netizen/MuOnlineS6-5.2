...
void CEventPvP::MainProc()
{
	...
	if (this->m_RemainTime > 0)
	{
		...
		{
			gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(699));
		...
		if (this->m_EventPvPEnter && this->m_Player1Index != -1 && this->m_Player2Index != -1)
		{
			...
			this->m_EventPvPEnter = 0;
			gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(601), gObj[this->m_Player1Index].Name, gObj[this->m_Player2Index].Name);
		...
		{
			gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(603), gObj[this->m_Player2Index].Name);
		...
		{
			gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(603), gObj[this->m_Player1Index].Name);
...
bool CEventPvP::CommandEventPvP(LPOBJ lpObj, char* arg) 
{
	...
	if (this->m_RemainTime > 0)
	{
		...
		gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(700));
	...
	gNotice.GCNoticeSend(lpObj->Index, 1, 0, 0, 0, 0, 0, gMessageNew.GetMessage(604));
...
void CEventPvP::EventPvPDead(int aIndex, int bIndex) 
{
	...
	{
		this->m_Score1++;
		gNotice.GCNoticeSendToAll(0, 0, 0, 0, 0, 0, gMessageNew.GetMessage(602), gObj[this->m_Player1Index].Name, this->m_Score1, this->m_Score2, gObj[this->m_Player2Index].Name);
