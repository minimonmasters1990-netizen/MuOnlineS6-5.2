...
{
	if (g_OfflineMode.m_MUOffHelperPickUpEnabled[0] == 0
		|| g_OfflineMode.m_MUOffHelperPickUpEnabled[1] == 0
		|| g_OfflineMode.m_MUOffHelperPickUpEnabled[2] == 0
		|| g_OfflineMode.m_MUOffHelperPickUpEnabled[3] == 0)
	{
		return 0;
	}
