...
bool CJewelMix::CommandJewelMix(LPOBJ lpObj,char* arg)
{
	...
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0, gMessageNew.GetMessage(620));
		return 0;
	}

	if(type < 0 || type > 9)
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0, gMessageNew.GetMessage(622));
		return 0;
	}
	...
	gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0, gMessageNew.GetMessage(623));
...
bool CJewelMix::CommandJewelUnMix(LPOBJ lpObj,char* arg)
{
	...
	{
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0, gMessageNew.GetMessage(621));
		return 0;
	}
	...
	{
		lpObj->ChaosLock = 0;
		gNotice.GCNoticeSend(lpObj->Index,1,0,0,0,0,0, gMessageNew.GetMessage(624));
		return 0;
	}
