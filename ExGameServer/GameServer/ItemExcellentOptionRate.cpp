...
CItemExOptionRate::CItemExOptionRate()
{
	this->m_ItemExOptionRateInfo.clear();
}

void CItemExOptionRate::Load(char* path)
{
...
bool CItemExOptionRate::GetExcellentOptionByRate(int ItemIndex, int NewOption, BYTE* OptionIndex)
{
