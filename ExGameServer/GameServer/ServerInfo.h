...
public:
	...
	void ReloadCfgSPK();
public:
	char m_CustomerKeyVersion[32];
	char m_CustomerName[32];
	char m_CustomerHardwareId[MAX_HWID_KEY];
...
//bat tat thong bao memonline
	...
	int m_RenderDameBossDelay;
	int m_RenderDameBossClear;
	...
	int m_PartyRestrict;
	int m_DifferenceMaxLevelParty;
	bool InSafeZone(int aIndex);

	int m_DissableBuffClass;
	int ElfNoBoltArrow;
	int SkillDocDW;
