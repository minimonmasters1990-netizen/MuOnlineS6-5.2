		...
		while (true)
		{
			...
			while (true)
			{
				...
				else if (section == 2)
				{
					...
					info.SlotElement[0] = lpMemScript->GetAsNumber(); // Set Item

					info.SlotElement[1] = lpMemScript->GetAsNumber(); // L Weapon

					info.SlotElement[2] = lpMemScript->GetAsNumber(); // R Weapon

					info.SlotElement[3] = lpMemScript->GetAsNumber(); // Slot Wing

					info.SlotElement[4] = lpMemScript->GetAsNumber(); // Skill
