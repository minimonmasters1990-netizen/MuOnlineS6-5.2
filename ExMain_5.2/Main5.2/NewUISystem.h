...
#include "ThangCuoi/NewUIMenu.h"
#include "ThangCuoi/NewUIRanking.h"
#include "ThangCuoi/ACuoi_JewelBank.h"
#include "ThangCuoi/SystemPKSend.h"
#include "ThangCuoi/NewUIEventTime.h"
#include "ThangCuoi/ACuoi_Relife.h"
#include "ThangCuoi/NewUIResetChange.h"
#include "ThangCuoi/ACuoi_DanhHieu.h"
#include "ThangCuoi/ACuoi_QuanHam.h"
#include "ThangCuoi/ACuoi_TuLuyen.h"

#include "ThangCuoi/NewUIRenderDameBoss.h"
#include "ThangCuoi/NewUIRenderInvasion.h"
#include "ThangCuoi/NewUIRenderCoin.h"
#include "ThangCuoi/ACuoi_VongQuay.h"
#include "ThangCuoi/NewUIViewItem.h"
#include "ThangCuoi/NewUIAccountLevel.h"
#include "ThangCuoi/NewUIMainMap.h"
#include "ThangCuoi/ACuoi_MocNap.h"
#include <ThangCuoi/NewUIChangeClass.h>
#include <ThangCuoi/NewUIQQ.h>
#include <ThangCuoi/NewUIChangePass.h>
#include <ThangCuoi/ACuoi_HonHoan.h>
#include <ThangCuoi/NewUICastleEvent.h>
#include <ThangCuoi/ACuoi_GiftCode.h>
#include <NewUIMuHelperSkillList.h>
#include <ThangCuoi/NewUIRenderColorItem.h>
#include <ThangCuoi/UIFormSystemRender.h>
#include <ThangCuoi/NewUINewShop.h>
...
namespace SEASON3B
{
	class CNewUISystem
	{
		...
		void RenderItem3DNew(float sx, float sy, float Width, float Height, int Type, int Level, int Option1, int ExtOption, bool PickUp, float Scale, bool FixY);
		...
		CUIFormSystemRender* m_pUIFormSystemRender;
...
#ifdef LEM_ADD_LUCKYITEM
		CNewUILuckyItemWnd*					_pNewUILuckyItemWnd;
#endif // LEM_ADD_LUCKYITEM
		...
		CNewUIMenuOption*					m_pNewUIMenuOption;
		CNewUIRanking*						m_pNewUIRanking;
		CNewUIJewelBank*					m_pNewUIJewelBank;
		CNewUIMainMap*						m_pNewUIMainMap;
		CNewUIPKSystem*						m_pNewUIPKSystem;
		CNewUIEventTime*					m_pNewUIEventTime;
		CNewUIRelife*						m_pNewUIRelife;
		CNewUIResetChange*					m_pNewUIResetChange;
		CNewUIGiftCode*					    m_pNewUIGiftCode;
		CNewUIDanhHieu*						m_pNewUIDanhHieu;
		CNewUIQuanHam*						m_pNewUIQuanHam;
		CNewUITuLuyen*						m_pNewUITuLuyen;
		CNewUIHonHoan*						m_pNewUIHonHoan;
		CNewUIRenderDameBoss*				m_pNewUIRenderDameBoss;
		CNewUIRenderInvasion*				m_pNewUIRenderInvasion;
		CNewUIRenderCoin*					m_pNewUIRenderCoin;
		CNewUISpinPush*						m_pNewUISpinPush;
		CNewUIViewItem*						m_pNewUIViewItem;
		CNewUIAccountLevel*					m_pNewUIAccountLevel;
		CNewUIMocNap*						m_pNewUIMocNap;
		CNewUINewShop*						m_pNewUINewShop;
		CNewUIChangeClass*					m_pNewUIChangeClass;
		CNewUIChangePass*					m_pNewUIChangePass;
		CNewUIQQ*							m_pNewUIQQ;
		CNewUICastleEvent*					m_pNewUICastleEvent;
		CNewUIRenderColorItem*				m_pNewUIRenderColorItem;
		CNewUIAutoReset*				    m_pNewUIAutoReset;

	public:
		CNewUIChatInputBox* GetUI_NewChatInputBox() const;
		CUIFormSystemRender* Get_pUIFormSystemRender()	const;
		...
		CNewUIMenuOption*			Get_pNewUIMenuOption()		const;
		CNewUIRanking*				Get_pNewUIRanking()			const;
		CNewUIMainMap*				Get_pNewUIMainMap()			const;
		CNewUIJewelBank*			Get_pNewUIJewelBank()		const;
		CNewUIPKSystem*				Get_pNewUIPKSystem()		const;
		CNewUIEventTime*			Get_pNewUIEventTime()		const;
		CNewUIRelife*				Get_pNewUIRelife()			const;
		CNewUIResetChange*			Get_pNewUIResetChange()		const;
		CNewUIGiftCode*			    Get_pNewUIGiftCode()		const;
		CNewUIDanhHieu*				Get_pNewUIDanhHieu()		const;
		CNewUIQuanHam*				Get_pNewUIQuanHam()			const;
		CNewUITuLuyen*				Get_pNewUITuLuyen()			const;
		CNewUIHonHoan*				Get_pNewUIHonHoan()			const;
		CNewUIRenderDameBoss*		Get_pNewUIRenderDameBoss()	const;
		CNewUIRenderInvasion*		Get_pNewUIRenderInvasion()	const;
		CNewUIRenderCoin*			Get_pNewUIRenderCoin()		const;
		CNewUISpinPush*				Get_pNewUISpinPush()		const;
		CNewUIViewItem*				Get_pNewUIViewItem()		const;
		CNewUIAccountLevel*			Get_pNewUIAccountLevel()	const;
		CNewUIMocNap*				Get_pNewUIMocNap()			const;
		CNewUINewShop*				Get_pNewUINewShop()			const;
		CNewUIChangeClass*			Get_pNewUIChangeClass()		const;
		CNewUIChangePass*			Get_pNewUIChangePass()		const;
		CNewUIQQ*					Get_pNewUIQQ()				const;
		CNewUICastleEvent*			Get_pNewUICastleEvent()		const;
		CNewUIRenderColorItem*		Get_pNewUIRenderColorItem()	const;
		CNewUIAutoReset*		    Get_pNewUIAutoReset()	const;

	};
}

#define g_pNewShop					SEASON3B::CNewUISystem::GetInstance()->Get_pNewUINewShop()
#define g_pUIForm					SEASON3B::CNewUISystem::GetInstance()->Get_pUIFormSystemRender()
#define g_pNewUIRenderColorItem		SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIRenderColorItem()
#define g_pNewUICastleEvent			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUICastleEvent()
#define g_pNewUIQQ					SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIQQ()
#define g_pNewUIChangePass			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIChangePass()
#define g_pNewUIChangeClass			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIChangeClass()
#define g_pNewUIMocNap				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIMocNap()
#define g_pNewUISpinPush			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUISpinPush()
#define g_pNewUIRenderCoin			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIRenderCoin()
#define g_pNewUIInvasion			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIRenderInvasion()
#define g_pNewUIMainMap				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIMainMap()
#define g_pNewUIAccountLevel		SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIAccountLevel()
#define g_pNewUIViewItem			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIViewItem()
#define g_pNewUIRenderDameBoss		SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIRenderDameBoss()
#define g_pNewUIDanhHieu			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIDanhHieu()
#define g_pNewUIQuanHam				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIQuanHam()
#define g_pNewUITuLuyen				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUITuLuyen()
#define g_pNewUIHonHoan				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIHonHoan()
#define g_pNewUIResetChange			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIResetChange()
#define g_pNewUIRelife				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIRelife()
#define g_pNewUIEventTime			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIEventTime()
#define g_pNewUIPKSystem			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIPKSystem()
#define g_pNewUIJewelBank			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIJewelBank()
#define g_pNewUIRanking				SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIRanking()
...
#define g_pNewUIAutoReset			SEASON3B::CNewUISystem::GetInstance()->Get_pNewUIAutoReset()
#ifdef LEM_ADD_LUCKYITEM
