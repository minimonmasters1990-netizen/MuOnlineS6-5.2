...
bool SEASON3B::CNewUICommandWindow::Render()
{
	...
	{	
		...
		if( m_iCurSelectCommand != COMMAND_NONE )
			m_BtnCommand[m_iCurSelectCommand].SetFont( g_hFont );
...
{
	RenderImage(IMAGE_COMMAND_BASE_WINDOW_BACK, m_Pos.x + 2, m_Pos.y + 3, float(COMMAND_WINDOW_WIDTH) - 4 , float(COMMAND_WINDOW_HEIGHT) - 3);
