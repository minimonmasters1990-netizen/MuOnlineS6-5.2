...
CHARACTER* CGMDoppelGanger1::CreateMonster(int iType, int PosX, int PosY, int Key)
{
    ...
    case 534:
        ...
        gCustomModelNPC.MakeNpcModel(pCharacter, 534);
        break;
    case 535:
        pCharacter = CreateCharacter(Key, MODEL_PLAYER, PosX, PosY);
        gCustomModelNPC.MakeNpcModel(pCharacter, 535);
        break;
    case 536:
        pCharacter = CreateCharacter(Key, MODEL_PLAYER, PosX, PosY);
        gCustomModelNPC.MakeNpcModel(pCharacter, 536);
        break;
    case 537:
        pCharacter = CreateCharacter(Key, MODEL_PLAYER, PosX, PosY);
        gCustomModelNPC.MakeNpcModel(pCharacter, 537);
        break;
    case 538:
        pCharacter = CreateCharacter(Key, MODEL_PLAYER, PosX, PosY);
        gCustomModelNPC.MakeNpcModel(pCharacter, 538);
        break;
    case 539:
        pCharacter = CreateCharacter(Key, MODEL_PLAYER, PosX, PosY);
        gCustomModelNPC.MakeNpcModel(pCharacter, 539);
        break;
    case 580:
        pCharacter = CreateCharacter(Key, MODEL_PLAYER, PosX, PosY);
        gCustomModelNPC.MakeNpcModel(pCharacter, 580);
        break;
    }
