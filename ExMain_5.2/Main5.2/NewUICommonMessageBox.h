...
namespace SEASON3B
{
	...
	class CMyShopBtnConfirmLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		static int m_ButtonIndex;
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
		static CALLBACK_RESULT CancelBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	};

	class CChangeClassConfirmLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CClearInventoryConfirmLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
