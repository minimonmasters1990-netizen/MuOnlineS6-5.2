	...
	WORD SkillIndex, WORD Skill, WORD SKKey)
{
	...
	{
		switch (Right) //ACuoi Effect skill bow
		{
			...
			case MODEL_BOW + 18:CreateEffect(MODEL_ARROW_BEST_CROSSBOW, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill);	break;
			case MODEL_BOW + 19:CreateEffect(MODEL_ARROW_DRILL, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
			
				
			case MODEL_BOW + 101:CreateEffect(MODEL_ARROW_SPARK, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;

				// them effect no ban ra ten tai day //Acuoi
			default:
		...
		switch (Left)
		{
			...
			case MODEL_BOW + 100:CreateEffect(MODEL_ARROW_SPARK, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
			case MODEL_BOW + 102:CreateEffect(MODEL_ARROW_SPARK, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
			case MODEL_BOW + 103:CreateEffect(MODEL_ARROW_SPARK, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;
			case MODEL_BOW + 104:CreateEffect(MODEL_ARROW_SPARK, o->Position, o->Angle, o->Light, SubType, o, o->PKKey, SkillIndex, Skill); break;

				// them effect Cung ban ra ten tai day //Acuoi
			default:
...
void CreateArrows(CHARACTER* c, OBJECT* o, OBJECT* to, WORD SkillIndex, WORD Skill, WORD SKKey)
{
	...
	else
	{
		if (Skill == 1)
		{
			...
			{
				if (SKKey == AT_SKILL_CROSSBOW || SKKey == MASTER_SKILL_ADD_TRIPLE_SHOT_IMPROVED)
				{
					o->Angle[2] += 5.f;
					CreateArrow(c, o, to, SkillIndex, Skill, SKKey);
					o->Angle[2] += 10.f;
