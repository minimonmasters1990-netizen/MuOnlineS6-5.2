...
void CPersonalShopTitleImp::CShopTitleDrawObj::Draw(int iPkLevel)
{
	...
	POINT RenderPos = { m_pos.x/gPosWide.x_fScreenRate_x, m_pos.y/gPosWide.x_fScreenRate_y };
	SIZE RenderBoxSize = { m_size.cx/gPosWide.x_fScreenRate_x, m_size.cy/gPosWide.x_fScreenRate_y };
	SIZE RenderIconSize = { m_icon.cx/gPosWide.x_fScreenRate_x, m_icon.cy/gPosWide.x_fScreenRate_y };
	...
	//ACuoi Render shop title
	if( !m_bottomTitle.empty() )
	{
		g_pRenderText->SetBgColor(108, 57, 41, 200);
		g_pRenderText->SetTextColor(255, 255, 255, 255);
		g_pRenderText->RenderText(RenderPos.x, RenderPos.y, m_topTitle.c_str(), RenderBoxSize.cx, iLineHeight, 1);
	}
