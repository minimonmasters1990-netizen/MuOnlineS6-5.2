...
void CMsgBoxIGSStorageItemInfo::RenderTexts()
{
	...
	g_pRenderText->RenderText(GetPos().x + IGS_BTN_OK_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, GlobalText[228], IMAGE_IGS_BTN_WIDTH, 0, RT3_SORT_CENTER);
	...
	{
		sprintf(szText, "ItemCode 3 : %d (%d, %d)", m_wItemCode, m_wItemCode/MAX_ITEM_INDEX, m_wItemCode%MAX_ITEM_INDEX);
	}
