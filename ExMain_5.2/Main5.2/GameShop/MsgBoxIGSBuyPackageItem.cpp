...
void CMsgBoxIGSBuyPackageItem::RenderTextButtons()
{
	IsToolKit.ThisFont(GetPos().x + IGS_BTN_BUY_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, HEX_COLOR_WHITE, 200, IMAGE_IGS_BTN_WIDTH, 0, 3, GlobalText[2891]);
	IsToolKit.ThisFont(GetPos().x + IGS_BTN_PRESENT_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, HEX_COLOR_WHITE, 0, IMAGE_IGS_BTN_WIDTH, 0, 3, GlobalText[2892]);
	IsToolKit.ThisFont(GetPos().x + IGS_BTN_CANCEL_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, HEX_COLOR_WHITE, 0, IMAGE_IGS_BTN_WIDTH, 0, 3, GlobalText[229]);
}
void CMsgBoxIGSBuyPackageItem::RenderTexts()
{
	...
	g_pRenderText->RenderText(GetPos().x + IGS_BTN_BUY_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, GlobalText[2891], IMAGE_IGS_BTN_WIDTH, 0, RT3_SORT_CENTER);
	g_pRenderText->RenderText(GetPos().x + IGS_BTN_PRESENT_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, GlobalText[2892], IMAGE_IGS_BTN_WIDTH, 0, RT3_SORT_CENTER);
	g_pRenderText->RenderText(GetPos().x + IGS_BTN_CANCEL_POS_X, GetPos().y + IGS_BTN_POS_Y + 8, GlobalText[229], IMAGE_IGS_BTN_WIDTH, 0, RT3_SORT_CENTER);
	...
	{
		sprintf(szText, "ItemCodeX : %d (%d, %d)", m_wItemCode, m_wItemCode/MAX_ITEM_INDEX, m_wItemCode%MAX_ITEM_INDEX);
	}
...
void CMsgBoxIGSBuyPackageItem::Render3D()
{
	...
	(
		GetPos().x + IGS_3DITEM_POS_X
		, GetPos().y + IGS_3DITEM_POS_Y - 8
		, IGS_3DITEM_WIDTH
		, IGS_3DITEM_HEIGHT
		, m_wItemCode
		, 0
