...
bool SEASON3B::CNewUIGuildInfoWindow::Check_Btn()
{
	...
	else if (m_nCurrentTab == 2 && GuildMark[Hero->GuildMarkIndex].UnionName[0] != NULL) //ACuoi Fix Out Lien Minh Crash
	{
...
{
	RenderImage(IMAGE_GUILDINFO_BACK, m_Pos.x + 2, m_Pos.y + 3, 186.f, 426.f);
...
void SEASON3B::CNewUIGuildInfoWindow::Render_Text()
{
	...
	POINT ptOrigin;
	sprintf(Text, GlobalText[180]);
	RenderText(Text, m_Pos.x, m_Pos.y + 12, 190, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER);
	...
	sprintf(Text, GlobalText[180]);
	RenderText(Text, m_Pos.x + 13 + (0 * 55), m_Pos.y + 76, 55, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER);
	glColor4f(0.6f, 0.6f, 0.6f, 1.f);
	...
	RenderText(Text, m_Pos.x + 13 + (1 * 55), m_Pos.y + 76, 55, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER);
	glColor4f(0.6f, 0.6f, 0.6f, 1.f);
	...
	RenderText(Text, m_Pos.x + 13 + (2 * 55), m_Pos.y + 76, 55, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER);
	glColor4f(0.6f, 0.6f, 0.6f, 1.f);
	...
	if (m_nCurrentTab == 0)
	{
		...
		sprintf(Text, "%s %s:", GlobalText[1332], GuildMark[Hero->GuildMarkIndex].GuildName);
		RenderText(Text, m_Pos.x + 22, Nm_Loc, 150, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_LEFT);
		Nm_Loc += 13;
		...
		RenderText(Text, m_Pos.x + 22, Nm_Loc, 80, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_LEFT);

		Nm_Loc += 13;
		sprintf(Text, "%s : %s", GlobalText[1321], m_RivalGuildName[0] ? m_RivalGuildName : GlobalText[1361]);
		RenderText(Text, m_Pos.x + 22, Nm_Loc, 0, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_LEFT);
	}
	else if (m_nCurrentTab == 1)
	{
		glColor4f(1.f, 1.f, 1.f, 1.f);
		RenderText((char*)GlobalText[1389], m_Pos.x + 24, m_Pos.y + 112, 40, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_LEFT);
		RenderText((char*)GlobalText[1307], m_Pos.x + 89, m_Pos.y + 112, 40, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_LEFT);
		RenderText((char*)GlobalText[1022], m_Pos.x + 126, m_Pos.y + 112, 40, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_LEFT);
	...
	else if (m_nCurrentTab == 2 && Hero->GuildStatus == G_MASTER)
	{
		glColor4f(1.f, 1.f, 1.f, 1.f);
