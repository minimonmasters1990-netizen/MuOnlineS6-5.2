...
namespace SEASON3B
{
	...
	{
		RenderImage(IMAGE_BACK, m_Pos.x + 2, m_Pos.y + 3, 186.f, 426.f);
	...
	void CNewUIRegistrationLuckyCoin::SetBtnInfo()
	{
		...
		m_RegistButton.SetFont(g_hFont);
	...
	void CNewUIRegistrationLuckyCoin::UnLockLuckyCoinRegBtn()
	{
		...
		m_RegistButton.ChangeTextColor(HEX_COLOR_WHITE);
	}
