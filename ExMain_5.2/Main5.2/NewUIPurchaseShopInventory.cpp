...
{
	RenderImage(IMAGE_MSGBOX_BACK, m_Pos.x + 2, m_Pos.y + 3, 186.f, 426.f);
...
{
	RenderText(GlobalText[1102], m_Pos.x, m_Pos.y + 10, 190, 0, 0xFF49B0FF, 0x00000000, RT3_SORT_CENTER);
	RenderText(m_TitleText.c_str(), m_Pos.x, m_Pos.y + 56, 190, 0, RGBA(0, 255, 0, 255), 0x00000000, RT3_SORT_CENTER, g_hFont);
	unicode::t_char Text[100];

	memset(&Text, 0, sizeof(unicode::t_char) * 100);
	sprintf(Text, GlobalText[370]);
	RenderText(Text, m_Pos.x + 30, m_Pos.y + 230, 0, 0, RGBA(255, 45, 47, 255), 0x00000000, RT3_SORT_LEFT, g_hFont);
	...
	RenderText(Text, m_Pos.x + 30, m_Pos.y + 320, 0, 0, RGBA(255, 45, 47, 255), 0x00000000, RT3_SORT_LEFT, g_hFont);

	memset(&Text, 0, sizeof(unicode::t_char) * 100);
	sprintf(Text, GlobalText[1135]);
	RenderText(Text, m_Pos.x + 30, m_Pos.y + 332, 0, 0, RGBA(255, 45, 47, 255), 0x00000000, RT3_SORT_LEFT, g_hFont);
}
