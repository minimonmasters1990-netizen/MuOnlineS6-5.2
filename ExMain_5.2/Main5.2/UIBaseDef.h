...
#include "UsefulDef.h"
#define HEX_COLOR_DARKGREEN	0x63FF8DFF
#define HEX_COLOR_WHITE		0xFFFFFFFF //mau trang
#define HEX_COLOR_ORANGE    0xFF9500FF //la mau cam
#define HEX_COLOR_BLUE		0x6496FFFF //la mau xanh port
#define HEX_COLOR_GREEN	    0x00FF00FF //la mau xanh la
#define HEX_COLOR_Yellow    0xFFDE26FF //la mau vang
