...
bool SEASON3B::CNewUIHotKey::UpdateKeyEvent()
{
	...
	else if (SEASON3B::IsPress(VK_F8) == true)
	{
		...
		g_pNewUISystem->Hide(SEASON3B::INTERFACE_EVENQUANHAM);
		g_pNewUISystem->Hide(SEASON3B::INTERFACE_EVENTULUYEN);
		g_pNewUISystem->Hide(SEASON3B::INTERFACE_EVENSPIN);
