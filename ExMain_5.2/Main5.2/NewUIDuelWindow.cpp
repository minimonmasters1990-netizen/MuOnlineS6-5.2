...
void SEASON3B::CNewUIDuelWindow::RenderContents()
{
	...
	glColor3f(0.0f, 0.588f, 1.0f);
	SEASON3B::RenderNumber(m_Pos.x + 34.5, m_Pos.y + 33, g_DuelMgr.GetScore(DUEL_HERO), 0.83f);
	...
	glColor3f(1.0f, 0.098f, 0.098f);
	SEASON3B::RenderNumber(m_Pos.x + 34.5, m_Pos.y + 56, g_DuelMgr.GetScore(DUEL_ENEMY), 0.83f);
	glColor3f(1.0f, 1.0f, 1.0f);
