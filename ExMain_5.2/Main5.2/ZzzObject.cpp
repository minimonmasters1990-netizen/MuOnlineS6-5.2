...
void ItemObjectAttribute(OBJECT* o)
{
    ...
    g_pNewUIRenderColorItem->RenderSetBlendEffect(o);
...
void PartObjectColor(int Type, float Alpha, float Bright, vec3_t Light, bool ExtraMon)
{
    ...
    else
    {
        ...
        #if RENDER_ITEM_3D
        if (g_pNewUIRenderColorItem)
        {
            if ((Section >= 0 && Section <= 6) || (Section >= 7 && Section <= 11) || Section == 12 || Section == 13)
            {
                if (Index == g_pNewUIRenderColorItem->RenderItem[5])
                {
                    Color = g_pNewUIRenderColorItem->RenderItem[ITEM_COLORSET];
                }
            }
        }
        #else
        //ACuoi Sua Mau Set Do
        if (Section == 0)
        {
            switch (Index)
            {
                ...
                case 20: Color = 15; break;
                case 21: Color = 5; break;
                case 22: Color = 15; break;
                case 23: Color = 15; break;
                case 24: Color = 0; break;
                case 25: Color = 0; break;
                case 31: Color = 5; break;
                case 28: Color = 15; break;
                case 32: Color = 17; break;
                case 33: Color = 0; break;
                case 34: Color = 25; break;
                case 35: Color = 12; break;
                case 47: Color = 1; break;

                case 60: Color = 53; break;
                case 81: Color = 51; break;

                case 100: Color = 79; break;
                case 101: Color = 70; break;
                case 102: Color = 54; break;
                case 103: Color = 92; break;
                case 104: Color = 72; break;
    ...
    switch (Color)
    {
        case 0: Vector(Bright * 1.0f, Bright * 0.5f, Bright * 0.0f, Light); break; // Cam đậm
        case 1: Vector(Bright * 1.0f, Bright * 0.2f, Bright * 0.0f, Light); break; // Đỏ cam
        case 2: Vector(Bright * 0.0f, Bright * 0.5f, Bright * 1.0f, Light); break; // Xanh dương nhạt
        case 3: Vector(Bright * 0.0f, Bright * 0.5f, Bright * 1.0f, Light); break; // Xanh dương nhạt
        case 4: Vector(Bright * 0.0f, Bright * 0.8f, Bright * 0.4f, Light); break; // Xanh lá ngọc
        case 5: Vector(Bright * 1.0f, Bright * 1.0f, Bright * 1.0f, Light); break; // Trắng tinh
        case 6: Vector(Bright * 0.6f, Bright * 0.8f, Bright * 0.4f, Light); break; // Xanh lá non
        case 7: Vector(Bright * 0.9f, Bright * 0.8f, Bright * 1.0f, Light); break; // Tím nhạt
        case 8: Vector(Bright * 0.8f, Bright * 0.8f, Bright * 1.0f, Light); break; // Xanh lam nhạt
        case 9: Vector(Bright * 0.5f, Bright * 0.5f, Bright * 0.8f, Light); break; // Xanh tím than
        case 10: Vector(Bright * 0.75f, Bright * 0.65f, Bright * 0.5f, Light); break; // Nâu sáng
        case 11: Vector(Bright * 0.35f, Bright * 0.35f, Bright * 0.6f, Light); break; // Xanh xám tối
        case 12: Vector(Bright * 0.47f, Bright * 0.67f, Bright * 0.6f, Light); break; // Xanh lam ngọc
        case 13: Vector(Bright * 0.0f, Bright * 0.3f, Bright * 0.6f, Light); break; // Xanh biển sẫm
        case 14: Vector(Bright * 0.65f, Bright * 0.65f, Bright * 0.55f, Light); break; // Xám vàng
        case 15: Vector(Bright * 0.2f, Bright * 0.3f, Bright * 0.6f, Light); break; // Xanh navy nhạt
        case 16: Vector(Bright * 0.8f, Bright * 0.46f, Bright * 0.25f, Light); break; // Nâu đỏ gạch
        case 17: Vector(Bright * 0.65f, Bright * 0.45f, Bright * 0.3f, Light); break; // Nâu đất
        case 18: Vector(Bright * 0.5f, Bright * 0.4f, Bright * 0.3f, Light); break; // Nâu cà phê
        case 19: Vector(Bright * 0.37f, Bright * 0.37f, Bright * 1.0f, Light); break; // Xanh tím sáng
        case 20: Vector(Bright * 0.3f, Bright * 0.7f, Bright * 0.3f, Light); break; // Xanh lá tươi
        case 21: Vector(Bright * 0.5f, Bright * 0.4f, Bright * 1.0f, Light); break; // Xanh tím đậm
        case 22: Vector(Bright * 0.45f, Bright * 0.45f, Bright * 0.23f, Light); break; // Nâu xám rêu
        case 23: Vector(Bright * 0.3f, Bright * 0.3f, Bright * 0.45f, Light); break; // Xanh đen
        case 24: Vector(Bright * 0.6f, Bright * 0.5f, Bright * 0.2f, Light); break; // Nâu vàng
        case 25: Vector(Bright * 0.6f, Bright * 0.6f, Bright * 0.6f, Light); break; // Xám nhạt
        case 26: Vector(Bright * 0.3f, Bright * 0.7f, Bright * 0.3f, Light); break; // Xanh lá (giống case 20)
        case 27: Vector(Bright * 0.5f, Bright * 0.6f, Bright * 0.7f, Light); break; // Xanh lam nhạt ghi
        case 28: Vector(Bright * 0.45f, Bright * 0.45f, Bright * 0.23f, Light); break; // Nâu rêu (giống case 22)
        case 29: Vector(Bright * 0.2f, Bright * 0.7f, Bright * 0.3f, Light); break; // Xanh lá non đậm
        case 30: Vector(Bright * 0.7f, Bright * 0.3f, Bright * 0.3f, Light); break; // Đỏ nâu
        case 31: Vector(Bright * 0.7f, Bright * 0.5f, Bright * 0.3f, Light); break; // Nâu cam
        case 32: Vector(Bright * 0.5f, Bright * 0.2f, Bright * 0.7f, Light); break; // Tím sẫm
        case 33: Vector(Bright * 0.8f, Bright * 0.4f, Bright * 0.6f, Light); break; // Hồng tím
        case 34: Vector(Bright * 0.6f, Bright * 0.4f, Bright * 0.8f, Light); break; // Tím nhạt ghi
        case 35: Vector(Bright * 0.7f, Bright * 0.4f, Bright * 0.4f, Light); break; // Đỏ đất
        case 36: Vector(Bright * 0.5f, Bright * 0.5f, Bright * 0.7f, Light); break; // Xanh tím than sáng
        case 37: Vector(Bright * 0.7f, Bright * 0.5f, Bright * 0.7f, Light); break; // Tím hồng
        case 38: Vector(Bright * 0.2f, Bright * 0.4f, Bright * 0.7f, Light); break; // Xanh lam sẫm
        case 39: Vector(Bright * 0.3f, Bright * 0.6f, Bright * 0.4f, Light); break; // Xanh lá rừng
        case 40: Vector(Bright * 0.7f, Bright * 0.2f, Bright * 0.2f, Light); break; // Đỏ sẫm
        case 41: Vector(Bright * 0.7f, Bright * 0.2f, Bright * 0.7f, Light); break; // Tím đỏ
        case 42: Vector(Bright * 0.8f, Bright * 0.4f, Bright * 0.0f, Light); break; // Cam cháy
        case 43: Vector(Bright * 0.8f, Bright * 0.6f, Bright * 0.2f, Light); break; // Nâu vàng đậm
        case 44: Vector(Bright * 0.8f, Bright * 0.7f, Bright * 0.4f, Light); break; // Vàng đất
        case 45: Vector(Bright * 0.5f, Bright * 0.8f, Bright * 0.9f, Light); break; // Xanh cyan nhạt
        case 46: Vector(Bright * 0.6f, Bright * 0.9f, Bright * 0.7f, Light); break; // Xanh lá pastel
        case 47: Vector(Bright * 0.9f, Bright * 0.5f, Bright * 0.4f, Light); break; // Đỏ gạch
        case 48: Vector(Bright * 0.4f, Bright * 0.6f, Bright * 0.9f, Light); break; // Xanh nước biển sáng
        case 49: Vector(Bright * 0.7f, Bright * 0.7f, Bright * 0.2f, Light); break; // Vàng nâu
        case 50: Vector(Bright * 0.3f, Bright * 0.9f, Bright * 0.4f, Light); break; // Xanh lá sáng neon
        case 51: Vector(Bright * 0.9f, Bright * 0.3f, Bright * 0.3f, Light); break; // Đỏ tươi
        case 52: Vector(Bright * 0.60f, Bright * 0.00f, Bright * 0.80f, Light); break; // Tím đậm
        case 53: Vector(Bright * 0.60f, Bright * 0.60f, Bright * 0.60f, Light); break; // Xám trung tính
        case 54: Vector(Bright * 0.35f, Bright * 0.35f, Bright * 0.35f, Light); break; // Xám đen

        case 55: Vector(Bright * 0.0f, Bright * 0.0f, Bright * 0.0f, Light); break;//Không Màu
        case 56: Vector(Bright * 1.00f, Bright * 0.60f, Bright * 0.80f, Light); break; // Hồng pastel
        case 57: Vector(Bright * 0.20f, Bright * 0.80f, Bright * 0.80f, Light); break; // Ngọc lam (Teal)
        case 58: Vector(Bright * 0.10f, Bright * 0.90f, Bright * 0.10f, Light); break; // Xanh lá neon
        case 59: Vector(Bright * 0.90f, Bright * 0.90f, Bright * 0.10f, Light); break; // Vàng neon
        case 60: Vector(Bright * 0.00f, Bright * 0.50f, Bright * 0.50f, Light); break; // Xanh cổ vịt
        case 61: Vector(Bright * 0.85f, Bright * 0.65f, Bright * 0.13f, Light); break; // Vàng đồng (Goldenrod)
        case 62: Vector(Bright * 0.85f, Bright * 0.3f, Bright * 0.55f, Light); break; // Đỏ tím nhẹ
        case 63: Vector(Bright * 0.98f, Bright * 0.50f, Bright * 0.45f, Light); break; // San hô (Coral)
        case 64: Vector(Bright * 0.60f, Bright * 0.20f, Bright * 0.20f, Light); break; // Đỏ rượu vang
        case 65: Vector(Bright * 0.40f, Bright * 0.20f, Bright * 0.00f, Light); break; // Nâu chocolate
        case 66: Vector(Bright * 0.25f, Bright * 0.88f, Bright * 0.82f, Light); break; // Ngọc lam sáng (Turquoise)
        case 67: Vector(Bright * 0.68f, Bright * 0.85f, Bright * 0.90f, Light); break; // Xanh băng (Ice Blue)
        case 68: Vector(Bright * 0.72f, Bright * 0.52f, Bright * 0.04f, Light); break; // Vàng nghệ
        case 69: Vector(Bright * 0.90f, Bright * 0.44f, Bright * 0.48f, Light); break; // Hồng đất
        case 70: Vector(Bright * 0.36f, Bright * 0.25f, Bright * 0.20f, Light); break; // Nâu gỗ mun
        case 71: Vector(Bright * 0.93f, Bright * 0.51f, Bright * 0.93f, Light); break; // Hồng tím (Orchid pastel)
        case 72: Vector(Bright * 0.00f, Bright * 0.20f, Bright * 0.40f, Light); break; // Xanh đại dương
        case 73: Vector(Bright * 0.50f, Bright * 0.00f, Bright * 0.25f, Light); break; // Tím mận (Plum Dark)
        case 74: Vector(Bright * 0.33f, Bright * 0.42f, Bright * 0.18f, Light); break; // Xanh rêu
        case 75: Vector(Bright * 0.80f, Bright * 0.36f, Bright * 0.36f, Light); break; // Đỏ gạch
        case 76: Vector(Bright * 0.94f, Bright * 0.90f, Bright * 0.55f, Light); break; // Vàng chanh
        case 77: Vector(Bright * 0.13f, Bright * 0.70f, Bright * 0.67f, Light); break; // Xanh ngọc biển
        case 78: Vector(Bright * 0.50f, Bright * 0.50f, Bright * 0.00f, Light); break; // Vàng ôliu
        case 79: Vector(Bright * 0.42f, Bright * 0.26f, Bright * 0.15f, Light); break; // Nâu cafe
        case 80: Vector(Bright * 0.60f, Bright * 0.60f, Bright * 0.20f, Light); break; // Vàng đất
        case 81: Vector(Bright * 0.25f, Bright * 0.41f, Bright * 0.88f, Light); break; // Xanh Hoàng Gia (Royal Blue)
        case 82: Vector(Bright * 0.00f, Bright * 0.98f, Bright * 0.60f, Light); break; // Xanh lục bảo (Emerald)
        case 83: Vector(Bright * 1.00f, Bright * 0.08f, Bright * 0.58f, Light); break; // Hồng neon
        case 84: Vector(Bright * 0.20f, Bright * 0.20f, Bright * 0.20f, Light); break; // Xám chì
        case 85: Vector(Bright * 0.99f, Bright * 0.96f, Bright * 0.90f, Light); break; // Trắng ngà
        case 86: Vector(Bright * 0.93f, Bright * 0.79f, Bright * 0.69f, Light); break; // Da cam nhạt (Peach)
        case 87: Vector(Bright * 0.85f, Bright * 0.44f, Bright * 0.84f, Light); break; // Tím hoa (Fuchsia)
        case 88: Vector(Bright * 0.60f, Bright * 0.80f, Bright * 1.00f, Light); break; // Xanh baby (Baby Blue)
        case 89: Vector(Bright * 0.13f, Bright * 0.55f, Bright * 0.13f, Light); break; // Xanh cỏ (Lawn Green)
        case 90: Vector(Bright * 0.74f, Bright * 0.72f, Bright * 0.42f, Light); break; // Vàng kaki
        case 91: Vector(Bright * 0.85f, Bright * 0.85f, Bright * 0.10f, Light); break; // Vàng tươi
        case 92: Vector(Bright * 0.50f, Bright * 0.20f, Bright * 0.10f, Light); break; // Nâu đỏ
        case 93: Vector(Bright * 0.98f, Bright * 0.92f, Bright * 0.84f, Light); break; // Kem sữa
        case 94: Vector(Bright * 0.53f, Bright * 0.81f, Bright * 0.92f, Light); break; // Xanh bầu trời
        case 95: Vector(Bright * 0.00f, Bright * 0.39f, Bright * 0.00f, Light); break; // Xanh rừng đậm
        case 96: Vector(Bright * 0.70f, Bright * 0.13f, Bright * 0.13f, Light); break; // Đỏ lửa (Firebrick)
        case 97: Vector(Bright * 0.42f, Bright * 0.35f, Bright * 0.80f, Light); break; // Tím Indigo
        case 98: Vector(Bright * 0.95f, Bright * 0.64f, Bright * 0.37f, Light); break; // Cam đất (Sandy Brown)
        case 99: Vector(Bright * 0.36f, Bright * 0.54f, Bright * 0.66f, Light); break; // Xanh xám thép (Steel Blue)
        case 100: Vector(Bright * 0.00f, Bright * 0.75f, Bright * 0.75f, Light); break; // Xanh ngọc lam đậm

        case 101: Vector(Bright * 0.00f, Bright * 1.00f, Bright * 0.50f, Light); break; // Neon Xanh lá sáng
        case 102: Vector(Bright * 1.00f, Bright * 0.00f, Bright * 1.00f, Light); break; // Neon Tím hồng
        case 103: Vector(Bright * 1.00f, Bright * 1.00f, Bright * 0.00f, Light); break; // Neon Vàng sáng
        case 104: Vector(Bright * 0.00f, Bright * 1.00f, Bright * 1.00f, Light); break; // Neon Aqua sáng
        case 105: Vector(Bright * 1.00f, Bright * 0.40f, Bright * 0.00f, Light); break; // Neon Cam cháy
        case 106: Vector(Bright * 0.20f, Bright * 1.00f, Bright * 0.20f, Light); break; // Neon Xanh cỏ
        case 107: Vector(Bright * 0.00f, Bright * 0.60f, Bright * 1.00f, Light); break; // Neon Xanh điện
        case 108: Vector(Bright * 1.00f, Bright * 0.00f, Bright * 0.40f, Light); break; // Neon Đỏ hồng
        case 109: Vector(Bright * 0.40f, Bright * 0.00f, Bright * 1.00f, Light); break; // Neon Tím điện
        case 110: Vector(Bright * 0.00f, Bright * 1.00f, Bright * 0.90f, Light); break; // Neon Xanh ngọc phát sáng

        case 111: Vector(Bright * 0.33f, Bright * 0.42f, Bright * 0.18f, Light); break; // Xanh Rêu Rừng
        case 112: Vector(Bright * 0.42f, Bright * 0.56f, Bright * 0.14f, Light); break; // Xanh Lá Ôliu Đậm
        case 113: Vector(Bright * 0.36f, Bright * 0.25f, Bright * 0.20f, Light); break; // Nâu Gỗ Tối
        case 114: Vector(Bright * 0.18f, Bright * 0.31f, Bright * 0.31f, Light); break; // Xanh Ngọc Sâu
        case 115: Vector(Bright * 0.70f, Bright * 0.56f, Bright * 0.56f, Light); break; // Hồng Đất Tối
        case 116: Vector(Bright * 0.12f, Bright * 0.56f, Bright * 1.00f, Light); break; // Xanh Trời Đại Dương
        case 117: Vector(Bright * 0.56f, Bright * 0.93f, Bright * 0.56f, Light); break; // Xanh Lục Non
        case 118: Vector(Bright * 0.42f, Bright * 0.26f, Bright * 0.15f, Light); break; // Nâu Đất
        case 119: Vector(Bright * 0.25f, Bright * 0.25f, Bright * 0.50f, Light); break; // Xanh Biển Tối
        case 120: Vector(Bright * 0.72f, Bright * 0.52f, Bright * 0.04f, Light); break; // Vàng Sa Mạc

        case 121: Vector(Bright * 0.75f, Bright * 0.75f, Bright * 0.75f, Light); break; // Bạc (Silver)
        case 122: Vector(Bright * 0.83f, Bright * 0.69f, Bright * 0.22f, Light); break; // Vàng Gold Metallic
        case 123: Vector(Bright * 0.72f, Bright * 0.53f, Bright * 0.04f, Light); break; // Đồng (Bronze)
        case 124: Vector(Bright * 0.66f, Bright * 0.66f, Bright * 0.66f, Light); break; // Xám bạc
        case 125: Vector(Bright * 0.41f, Bright * 0.41f, Bright * 0.41f, Light); break; // Xám đậm thép
        case 126: Vector(Bright * 0.18f, Bright * 0.31f, Bright * 0.31f, Light); break; // Xanh thép mờ
        case 127: Vector(Bright * 0.55f, Bright * 0.27f, Bright * 0.07f, Light); break; // Đồng đỏ
        case 128: Vector(Bright * 0.90f, Bright * 0.91f, Bright * 0.98f, Light); break; // Bạc trắng
        case 129: Vector(Bright * 0.75f, Bright * 0.65f, Bright * 0.65f, Light); break; // Xám hồng nhạt
        case 130: Vector(Bright * 0.50f, Bright * 0.50f, Bright * 0.50f, Light); break; // Xám trung tính

        case 131: Vector(Bright * 0.30f, Bright * 0.00f, Bright * 0.50f, Light); break; // Ma Pháp Tím
        case 132: Vector(Bright * 0.00f, Bright * 0.30f, Bright * 0.60f, Light); break; // Xanh Nước Biển Sâu
        case 133: Vector(Bright * 0.60f, Bright * 0.00f, Bright * 0.20f, Light); break; // Máu Đỏ
        case 134: Vector(Bright * 0.70f, Bright * 0.00f, Bright * 0.70f, Light); break; // Hồng Tím Fantasy
        case 135: Vector(Bright * 0.15f, Bright * 0.50f, Bright * 0.30f, Light); break; // Xanh Lá Thần Thoại
        case 136: Vector(Bright * 0.40f, Bright * 0.80f, Bright * 0.60f, Light); break; // Xanh Phát Quang
        case 137: Vector(Bright * 0.60f, Bright * 0.10f, Bright * 0.70f, Light); break; // Tím Huyền Bí
        case 138: Vector(Bright * 0.25f, Bright * 0.75f, Bright * 1.00f, Light); break; // Xanh Crystal
        case 139: Vector(Bright * 0.80f, Bright * 0.20f, Bright * 0.40f, Light); break; // Đỏ Ruby
        case 140: Vector(Bright * 0.95f, Bright * 0.64f, Bright * 1.00f, Light); break; // Hồng Thạch Anh
        
        case 141: Vector(Bright * 0.10f, Bright * 0.10f, Bright * 0.30f, Light); break; // Xanh Đêm Sâu
        case 142: Vector(Bright * 0.30f, Bright * 0.05f, Bright * 0.70f, Light); break; // Tím Ma Thuật
        case 143: Vector(Bright * 0.00f, Bright * 0.20f, Bright * 0.10f, Light); break; // Xanh Rêu Tối
        case 144: Vector(Bright * 0.50f, Bright * 0.05f, Bright * 0.05f, Light); break; // Đỏ Máu Sẫm
        case 145: Vector(Bright * 0.80f, Bright * 0.60f, Bright * 0.80f, Light); break; // Tím Hồng Phấn
        case 146: Vector(Bright * 0.20f, Bright * 0.40f, Bright * 0.70f, Light); break; // Xanh Bầu Trời Chiều
        case 147: Vector(Bright * 0.60f, Bright * 0.80f, Bright * 0.20f, Light); break; // Xanh Lá Non Vàng
        case 148: Vector(Bright * 0.80f, Bright * 0.30f, Bright * 0.60f, Light); break; // Hồng Tím Ngọc
        case 149: Vector(Bright * 0.45f, Bright * 0.20f, Bright * 0.70f, Light); break; // Tím Pha Xanh
        case 150: Vector(Bright * 0.20f, Bright * 0.70f, Bright * 0.70f, Light); break; // Aqua Khói

        case 151: Vector(Bright * 0.36f, Bright * 0.20f, Bright * 0.09f, Light); break; // Nâu Đất Ẩm
        case 152: Vector(Bright * 0.15f, Bright * 0.25f, Bright * 0.50f, Light); break; // Xanh Biển Đêm
        case 153: Vector(Bright * 0.80f, Bright * 0.70f, Bright * 0.50f, Light); break; // Vàng Cát Nhạt
        case 154: Vector(Bright * 0.05f, Bright * 0.40f, Bright * 0.05f, Light); break; // Xanh Rừng Thẳm
        case 155: Vector(Bright * 0.70f, Bright * 0.35f, Bright * 0.10f, Light); break; // Nâu Cam Đất
        case 156: Vector(Bright * 0.20f, Bright * 0.50f, Bright * 0.25f, Light); break; // Xanh Lục Thảo
        case 157: Vector(Bright * 0.85f, Bright * 0.55f, Bright * 0.25f, Light); break; // Cam Đất Sáng
        case 158: Vector(Bright * 0.25f, Bright * 0.40f, Bright * 0.70f, Light); break; // Xanh Biển Mây
        case 159: Vector(Bright * 0.50f, Bright * 0.65f, Bright * 0.35f, Light); break; // Xanh Rừng Mềm
        case 160: Vector(Bright * 0.40f, Bright * 0.20f, Bright * 0.20f, Light); break; // Nâu Đỏ

        case 161: Vector(Bright * 0.00f, Bright * 0.90f, Bright * 0.30f, Light); break; // Neon Xanh Chanh
        case 162: Vector(Bright * 1.00f, Bright * 0.20f, Bright * 0.70f, Light); break; // Neon Hồng Tím
        case 163: Vector(Bright * 0.70f, Bright * 0.10f, Bright * 1.00f, Light); break; // Neon Tím Sáng
        case 164: Vector(Bright * 0.20f, Bright * 0.80f, Bright * 1.00f, Light); break; // Neon Xanh Dương Lạnh
        case 165: Vector(Bright * 1.00f, Bright * 0.80f, Bright * 0.00f, Light); break; // Neon Vàng Chanh
        case 166: Vector(Bright * 0.00f, Bright * 1.00f, Bright * 0.70f, Light); break; // Neon Xanh Ngọc Sáng
        case 167: Vector(Bright * 1.00f, Bright * 0.50f, Bright * 0.20f, Light); break; // Neon Cam Sáng
        case 168: Vector(Bright * 0.60f, Bright * 0.00f, Bright * 0.80f, Light); break; // Neon Tím Huyền
        case 169: Vector(Bright * 0.00f, Bright * 0.50f, Bright * 1.00f, Light); break; // Neon Xanh Nước Biển
        case 170: Vector(Bright * 1.00f, Bright * 0.10f, Bright * 0.10f, Light); break; // Neon Đỏ Chói

        case 171: Vector(Bright * 0.95f, Bright * 0.77f, Bright * 0.18f, Light); break; // Vàng Metallic Đậm
        case 172: Vector(Bright * 0.80f, Bright * 0.50f, Bright * 0.20f, Light); break; // Đồng Cổ
        case 173: Vector(Bright * 0.70f, Bright * 0.70f, Bright * 0.80f, Light); break; // Bạc Xanh Nhạt
        case 174: Vector(Bright * 0.60f, Bright * 0.45f, Bright * 0.45f, Light); break; // Xám Hồng Đồng
        case 175: Vector(Bright * 0.50f, Bright * 0.60f, Bright * 0.70f, Light); break; // Xám Xanh
        case 176: Vector(Bright * 0.40f, Bright * 0.55f, Bright * 0.55f, Light); break; // Xanh Thép
        case 177: Vector(Bright * 0.25f, Bright * 0.30f, Bright * 0.35f, Light); break; // Xám Than
        case 178: Vector(Bright * 0.55f, Bright * 0.55f, Bright * 0.65f, Light); break; // Xám Tím Nhạt
        case 179: Vector(Bright * 0.95f, Bright * 0.95f, Bright * 1.00f, Light); break; // Trắng Bạc Sáng
        case 180: Vector(Bright * 0.35f, Bright * 0.35f, Bright * 0.35f, Light); break; // Xám Graphite

        case 181: Vector(Bright * 0.95f, Bright * 0.80f, Bright * 0.80f, Light); break; // Pastel Hồng Nhạt
        case 182: Vector(Bright * 0.80f, Bright * 0.95f, Bright * 0.80f, Light); break; // Pastel Xanh Lá Dịu
        case 183: Vector(Bright * 0.80f, Bright * 0.85f, Bright * 1.00f, Light); break; // Pastel Xanh Trời Nhạt
        case 184: Vector(Bright * 0.90f, Bright * 0.80f, Bright * 1.00f, Light); break; // Pastel Tím Sữa
        case 185: Vector(Bright * 0.85f, Bright * 0.85f, Bright * 0.60f, Light); break; // Pastel Vàng Rêu
        case 186: Vector(Bright * 0.70f, Bright * 0.90f, Bright * 0.90f, Light); break; // Pastel Aqua Nhạt
        case 187: Vector(Bright * 0.95f, Bright * 0.90f, Bright * 0.70f, Light); break; // Pastel Be Sáng
        case 188: Vector(Bright * 0.75f, Bright * 0.65f, Bright * 0.90f, Light); break; // Pastel Tím Nhẹ
        case 189: Vector(Bright * 0.60f, Bright * 0.80f, Bright * 0.90f, Light); break; // Pastel Xanh Nước Biển Nhẹ
        case 190: Vector(Bright * 0.90f, Bright * 0.90f, Bright * 0.90f, Light); break; // Pastel Trắng Sữa
...
{
    int MonsterGolden = gCustomMonsterGlow.HasBrightness(iMonsterIndex);
...
void RenderPartObjectEffect(OBJECT* o, int Type, vec3_t Light, float Alpha, int ItemLevel, int Option1, int ExtOption, int Select, int RenderType)
{
    ...
    else if ((Type == MODEL_WING + 36 || Type == MODEL_WING + 157) && gMapManager.InBloodCastle() == false) //ACuoi Fix Wing 3 BC Crash
    {
        vec3_t vRelativePos, vPos, vLight;
        Vector(0.f, 0.f, 0.f, vRelativePos);
        Vector(0.f, 0.f, 0.f, vPos);
