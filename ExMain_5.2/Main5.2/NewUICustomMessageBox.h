...
namespace SEASON3B
{
	...
	class CAddStatPointMsgBoxLayout : public TMsgBoxLayout<CNewUITextInputMsgBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT ReturnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CMasterSkillPointMsgBoxLayout : public TMsgBoxLayout<CNewUITextInputMsgBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT ReturnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CStsConfirmOkCancelLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		virtual bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
		static CALLBACK_RESULT CancelBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	};
