...
void OpenBasicData(HDC hDC)
{
	...
	*/
	...
	sprintf(Text, "Data\\Local\\Dialog.bmd");
	OpenDialogFile(Text);

	sprintf(Text, "Data\\Local\\Item.bmd");
	OpenItemScript(Text);

	sprintf(Text, "Data\\Local\\MoveReq.bmd");
	SEASON3B::CMoveCommandData::OpenMoveReqScript(Text);

	sprintf(Text, "Data\\Local\\NpcName.txt");
	OpenMonsterScript(Text);

	sprintf(Text, "Data\\Local\\Quest.bmd");
	g_csQuest.OpenQuestScript(Text);

	sprintf(Text, "Data\\Local\\Skill.bmd");
	OpenSkillScript(Text);

	sprintf(Text, "Data\\Local\\SocketItem.bmd");
