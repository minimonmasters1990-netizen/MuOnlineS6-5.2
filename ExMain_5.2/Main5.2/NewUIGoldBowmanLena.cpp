...
{
	// frame
	RenderImage(IMAGE_GBL_BACK, m_Pos.x + 2, m_Pos.y + 3, 186.f, 426.f);
...
void CNewUIGoldBowmanLena::RenderTexts()
{
	...
	for( int i = 0; i < 3; ++i ) {
		...
		RenderText( Text, m_Pos.x, m_Pos.y+100+(i*15), 190, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER );
	}
	...
	RenderText( Text, m_Pos.x+5, m_Pos.y+202, 190, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER );
	...
	RenderText( Text, m_Pos.x+5, m_Pos.y+245, 190, 0, HEX_COLOR_WHITE, 0x00000000, RT3_SORT_CENTER );
