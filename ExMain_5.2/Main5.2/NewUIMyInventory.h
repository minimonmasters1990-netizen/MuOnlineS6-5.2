...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_INVENTORY_CLEARN_BTN, //"newui_expansion_btn.tga"
	...
	protected:
		...
		void SetButtonInfo();
		bool HasAnyItem(CNewUIInventoryCtrl* pCtrl);
	private:
		...
		static bool TryConsumeItemBank(CNewUIInventoryCtrl* targetControl, ITEM* pItem, const int iIndex);
