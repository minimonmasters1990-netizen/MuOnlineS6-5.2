...
#define EQUIPMENT_CUSTOM_1     12
#define EQUIPMENT_CUSTOM_2     13
#define EQUIPMENT_CUSTOM_3     14
#define EQUIPMENT_CUSTOM_4     15
#define EQUIPMENT_CUSTOM_5     16
#define EQUIPMENT_CUSTOM_START EQUIPMENT_CUSTOM_1
#define EQUIPMENT_CUSTOM_END   EQUIPMENT_CUSTOM_5
#define MAX_EQUIPMENT          17
