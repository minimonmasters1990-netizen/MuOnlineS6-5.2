...
void CButton::Render()
{
	...
	if (NULL == m_szText)
		...
		g_pRenderText->RenderText(int(CSprite::GetXPos() / gPosWide.x_fScreenRate_x), int(((float)CSprite::GetYPos() + fTextRelativeYPos) / gPosWide.x_fScreenRate_y + m_fTextAddYPos), m_szText, CSprite::GetWidth() / gPosWide.x_fScreenRate_x, 0, RT3_SORT_CENTER);
