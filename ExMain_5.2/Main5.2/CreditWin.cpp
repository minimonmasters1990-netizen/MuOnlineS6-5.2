...
void CCreditWin::RenderControls()
{
	...
	nTextBoxWidth = lScreenWidth / gPosWide.x_fScreenRate_x;
	...
	case 1:
		...
		break;
	case 2:
		nTextBoxWidth = lScreenWidth / 4 / gPosWide.x_fScreenRate_x;
		...
		break;
	case 3:
		nTextBoxWidth = lScreenWidth / 3 / gPosWide.x_fScreenRate_x;
		g_pRenderText->RenderText(0, 72, m_aCredit[m_anTextIndex[CRW_INDEX_NAME0]].szName,nTextBoxWidth, 0, RT3_SORT_CENTER);
