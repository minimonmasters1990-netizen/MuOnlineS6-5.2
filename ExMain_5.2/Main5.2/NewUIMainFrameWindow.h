...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			#if Ex700
			IMAGE_GAUGE_END	= BITMAP_START_SPK + 101,
			IMAGE_GAUGE_END_MANA	= BITMAP_START_SPK + 102,
			IMAGE_GAUGE_END_FORM	= BITMAP_START_SPK + 103,
			IMAGE_GAUGE_BTN_01		= BITMAP_START_SPK + 121,
			IMAGE_GAUGE_BTN_02		= BITMAP_START_SPK + 122,
			IMAGE_GAUGE_BTN_03		= BITMAP_START_SPK + 123,
			IMAGE_GAUGE_BTN_04		= BITMAP_START_SPK + 124,
			IMAGE_GAUGE_BTN_05		= BITMAP_START_SPK + 125,
			IMAGE_GAUGE_BTN_06		= BITMAP_START_SPK + 126,
			IMAGE_GAUGE_BTN_07		= BITMAP_START_SPK + 127,
			IMAGE_GAUGE_BTN_08		= BITMAP_START_SPK + 128,
			IMAGE_GAUGE_BTN_09		= BITMAP_START_SPK + 129,
			IMAGE_GAUGE_BTN_10		= BITMAP_START_SPK + 130,
			IMAGE_GAUGE_BTN_11		= BITMAP_START_SPK + 131,
			IMAGE_GAUGE_BTN_12		= BITMAP_START_SPK + 132,
			#endif
		};
