...
void ChatServerProtocolCore(int index,BYTE head,BYTE* lpMsg,int size) // OK
{
	...
	switch(head)
	{
		case 0x60:	FriendListRequest((FHP_FRIENDLIST_REQ*)lpMsg,index);				break;
		case 0x63:	FriendAddRequest((FHP_FRIEND_ADD_REQ*)lpMsg,index);					break;
		case 0x64:	WaitFriendAddRequest((FHP_WAITFRIEND_ADD_REQ*)lpMsg,index);			break;
		case 0x65:	FriendDelRequest((FHP_FRIEND_ADD_REQ*)lpMsg,index);					break;
		case 0x70:	FriendMemoSend((FHP_FRIEND_MEMO_SEND*)lpMsg,index);					break;
		case 0x71:	FriendMemoListReq((FHP_FRIEND_MEMO_LIST_REQ*)lpMsg,index);			break;
		case 0x72:	FriendMemoReadReq((FHP_FRIEND_MEMO_RECV_REQ*)lpMsg,index);			break;
		case 0x73:	FriendMemoDelReq((FHP_FRIEND_MEMO_DEL_REQ*)lpMsg,index);			break;
	}
	PROTECT_FINAL
}
