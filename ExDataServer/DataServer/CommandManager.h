...
public:
	...
	void GDCommandGiftCodeRecv(SDHP_COMMAND_GIFT_RECV* lpMsg, int index);
	void GDCommandGiftCodeSave(SDHP_COMMAND_GIFT_SAVE* lpMsg, int index);
};
