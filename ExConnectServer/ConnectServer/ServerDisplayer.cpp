...
void CServerDisplayer::Init(HWND hWnd)
{
	...
	HWND hReloadButton = CreateWindowW(L"BUTTON", L"Reload Config", WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 585, 80, 167, 30, this->m_hwnd, (HMENU)IDM_RELOAD_RELOADSERVERLIST, GetModuleHandle(NULL), NULL);
	...
	HWND hExitButton = CreateWindowW(L"BUTTON", L"Exit ConnectSever", WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON, 585, 142, 167, 30, this->m_hwnd, (HMENU)IDM_EXIT, GetModuleHandle(NULL), NULL);
