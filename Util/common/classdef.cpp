...
void classdef::Init()
{
		...
		VM_START_WITHLEVEL(17)
			...
			{
		// Dark Wizard
		this->SetCharacter( 0, 18, 18, 15, 30, 60.0, 60.0, 1.0, 2.0, ReadConfig.VitalityToLife_DW, 2.0, 0);

		// Dark Knight
		this->SetCharacter( 1, 28, 20, 25, 10, 110.0, 20.0, 2.0, 0.5, ReadConfig.VitalityToLife_DK, 1.0, 0);

		// Elf
		this->SetCharacter( 2, 22, 25, 20, 15, 80.0, 30.0, 1.0, 1.5, ReadConfig.VitalityToLife_ELF, 1.5, 0);

		// Magic Gladiator
		this->SetCharacter( 3, 26, 26, 26, 26, 110.0, 60.0, 1.0, 1.0, ReadConfig.VitalityToLife_MG, 2.0, 0);

		// Dark Lord
		this->SetCharacter( 4, 26, 20, 20, 15, 90.0, 40.0, 1.5, 1.0, ReadConfig.VitalityToLife_DL, 1.5, 25);
				
		// Summoner
		this->SetCharacter( 5, 18, 18, 15, 30, 60.0, 60.0, 1.0, 2.0, ReadConfig.VitalityToLife_SUM, 2.0, 0);

		// Rage Figher
		this->SetCharacter( 6, 32, 27, 25, 20, 100.0, 40.0, 1.3, 1.0, ReadConfig.VitalityToLife_RF, 1.3, 0);
			}else
			{
				// Dark Wizard
