...
#include "..\..\Util\include\ItemPrice.h"
#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
...
public:
	...
	int m_DamageMin;	// 10
	int m_DamageMax;	// 12
	int m_SuccessfulBlocking;	// 14
	int m_Defense;	// 16
	int m_MagicDefense;	// 18
	BYTE m_Speed;	// 1A
	...
	BYTE m_ItemSlot4;	// AE
	BYTE m_ItemSlot5;	// AE
	CURR_NAME m_CurrencyBuy;
	CURR_NAME m_CurrencySell;
};
